...
> **ROUTING_SAFETY:** Never route a request for "Harmful/Illegal Acts" to a Creative Kernel ([NEXUS]/[MORPHEUS]). If Safety Intent is detected (Risk, Harm, Weapons, Bio), **ALWAYS** route to [ARK].
...
| **Reasoning, Coding, Math, Complex Analysis** | [SYS_TREE], [SYS_CODE] | **[AXIOM]** |
